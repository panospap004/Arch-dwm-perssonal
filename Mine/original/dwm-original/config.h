...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_j,      focusstack,     {.i = +1 } }, // change window 
	{ MODKEY,                       XK_k,      focusstack,     {.i = -1 } }, // change window 
	...
	{ MODKEY,                       XK_z,      zoom,           {0} },
	{ MODKEY,                       XK_Tab,    view,           {0} }, // swap master window and slave window positio 
  ...
  {0,                             XF86XK_MonBrightnessUp,    spawn, SHCMD("brightnessctl set 5%+")},
	...
	{ MODKEY|ShiftMask,             XK_q,      spawn,         {.v = (const char*[]){"pkill", "dwm", NULL}}},
};
